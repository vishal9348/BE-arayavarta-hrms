...
@Table(
        ...
        indexes = {
                @Index(
                        name = "idx_legal_entity_tenant_id",
                        columnList = "tenant_id"
                ),
                @Index(
                        name = "idx_legal_entity_tenant_name",
                        columnList = "tenant_id, name"
                ),
                @Index(
                        name = "idx_legal_entity_registration_number",
                        columnList = "registration_number"
                )
        },
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_legal_entity_tenant_code",
                        columnNames = {
                                "tenant_id",
                                "code"
                        }
                ...
                @UniqueConstraint(
                        name = "uk_legal_entity_tenant_registration_number",
                        columnNames = {
                                "tenant_id",
                                "registration_number"
                        }
